...
$cfg['blowfish_secret']					= 'H~-Nh:`c?t{A/s~Ss8d5)ksG1v?98gU-' ;  // i.e. '$b~`lnkwm>^^jNUEE;(4xB$L\'b?."\'o9' 
...
$cfg['PmaAbsoluteUri'] 					= '/wp-content/plugins/wp-phpmyadmin-extension/lib/phpMyAdmin_y0mWrxkZPucTiUSEQ4jVz62/';			//used, if different directory by htaccess ; or parse_url($GLOBALS['PMA_PHP_SELF']);
