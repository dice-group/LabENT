...
echo "<br> <br>";
echo "<div>";
echo "<input class='u-border-none u-btn u-btn-round u-button-style u-palette-4-dark-2 u-radius-6 u-btn-1'  type='submit' name='submit' value='Submit' style='position: relative; left: 30%; padding: 5x 50px;'>";
echo "</div>";
